...
# Visualizacion de ambos conjuntos de datos
...
plot(felidos_dentro_sarapiqui, add=TRUE)
```
...
1. Union espacial de felidos y cantones. Esto agregara al conjunto de de datos de felidos una columna correspondiente al codigo de canton en que se ubica cada registro de felidos 
...
2. Conteo de la cantidad de especies de felidos en cada canton (por codigo de canton)
...
4. Generacion del mapa de coropletas 
